    ...
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                ...
                .SetUrl("~/Nca.Themes.MainTheme/vendor/jquery/jquery.min.js", "~/Nca.Themes.MainTheme/vendor/jquery/jquery.js")
            ...
            manifest
                ...
                .SetUrl("~/Nca.Themes.MainTheme/vendor/jquery/jquery.slim.min.js", "~/Nca.Themes.MainTheme/vendor/jquery/jquery.slim.js")
            ...
            manifest
                ...
                .SetUrl("~/Nca.Themes.MainTheme/vendor/bootstrap/js/bootstrap.min.js", "~/Nca.Themes.MainTheme/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                ...
                .SetDependencies("TheBlogTheme-vendor-jQuery")
                .SetUrl("~/Nca.Themes.MainTheme/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/Nca.Themes.MainTheme/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                ...
                .SetUrl("~/Nca.Themes.MainTheme/vendor/bootstrap/css/bootstrap.min.css", "~/Nca.Themes.MainTheme/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                ...
                .SetUrl("~/Nca.Themes.MainTheme/css/bootstrap-oc.min.css", "~/Nca.Themes.MainTheme/css/bootstrap-oc.css")
                .SetVersion("1.0.0");
				
            manifest
                .DefineStyle("TheBlogTheme-vendor-font-awesome")
                .SetUrl("~/Nca.Themes.MainTheme/vendor/fontawesome-free/css/all.min.css", "~/Nca.Themes.MainTheme/vendor/fontawesome-free/css/all.css")
